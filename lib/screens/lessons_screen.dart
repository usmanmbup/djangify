...
class LessonsScreen extends StatefulWidget {
  ...
  LessonsScreen({required this.selectedClass, required this.selectedCourse});
...
class _LessonsScreenState extends State<LessonsScreen> {
  ...
  void initState() {
    ...
    if (widget.selectedClass.isNotEmpty && widget.selectedCourse.isNotEmpty) {
      lessonsCollection = FirebaseFirestore.instance
          .collection('lessons')
  ...
  Future<void> downloadFile(String url, String fileName) async {
    final downloadDir = await getDownloadDirectory();
    setState(() {
      isDownloading[fileName] = true; // Start downloading
    });
    ...
    try {
      ...
      setState(() {
        isDownloading[fileName] = false; // End downloading
      });
    }
  }
      ...
      return Scaffold(
        ...
        body: Stack(
          children: [
            ...
            // Main content inside Padding and Column
            Padding(
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 30),
                // StreamBuilder for fetching lessons
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                        return Center(child: Text('Aucune leçon disponible.'));
                      }
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w600, // Lighter boldness
                                  ...
                                  trailing: isDownloading[fileName] == true
                                    ...
                                    onPressed: isDownloaded
                                        ? null // Disable button if downloaded
                                  ...
                                  onTap: () async {
                                    if (isDownloaded) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(
                                          content: Text('Veuillez télécharger le fichier d\'abord.'),
                                        ),
                                      );
                                    }
                                  },
